...
frappe.query_reports["zzMonthly Attendance Sheet Summary"] = {
	filters: [
		{
			fieldname: "month",
			label: __("Month"),
		...
		},
		{
			...
			label: __("View Detailed 'On Leave' Type"),
			fieldtype: "Check",
			default: 1,
			// depends_on: "eval:doc.summarized_view != 1",
		},
		{
			fieldname: "view_chart_details",
			label: __("View Chart Details"),
			fieldtype: "Check",
			default: 0,
			// depends_on: "eval:doc.summarized_view == 1",
		},
