frappe.pages["ro-plant-dashboard"].on_page_load = function (wrapper) {
    ...
    $(page.body).on("click", "#show-trend", function () {
        ...
        frappe.call({
            method:
                "informatics_custom_apps.eth.page.ro_plant_dashboard.ro_plant_dashboard.get_parameter_trend",
...
function loadParameters() {
    ...
    frappe.call({
        method:
            "informatics_custom_apps.eth.page.ro_plant_dashboard.ro_plant_dashboard.get_parameters",
...
function loadDashboard() {
    ...
    frappe.call({
        method:
            "informatics_custom_apps.eth.page.ro_plant_dashboard.ro_plant_dashboard.get_dashboard",
...
function renderPlantSummary(plants) {
    ...
    plants.forEach(p => {
        ...
        let badge = p.violations > 0 ? "danger" : "success";

        html += `
            <tr class="plant-row" data-plant="${p.plant}">
...
function loadPlantDetails(plant, target) {
    ...
    frappe.call({
        ...
        method:
            "informatics_custom_apps.eth.page.ro_plant_dashboard.ro_plant_dashboard.get_plant_logbook",
...
function renderTrendChart(result) {
    ...
    new frappe.Chart("#trend-graph", {
        ...
        title:
            `${$("#trend-parameter option:selected").text()} Trend`,
    ...
    let table = `
        ...
        <details style="margin-top:20px;">
            ...
            <summary>
                <b>Recorded Values (${result.data.length})</b>
            </summary>
